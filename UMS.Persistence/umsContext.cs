...
namespace UMS.Persistence
{
    public partial class umsContext : DbContext
    {
        ...
        public virtual DbSet<SessionTime> SessionTimes { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseNpgsql("Host=localhost;Port=5432;Database=ums;Username=postgres;Password=123456",o=>o.UseNodaTime());
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SessionTime>(entity =>
            {
                ...
                entity.HasIndex(e => e.Id, "sessiontime_id_uindex")
                    .IsUnique();
            ...
            modelBuilder.Entity<TeacherPerCoursePerSessionTime>(entity =>
            {
                ...
                entity.HasOne(d => d.SessionTime)
                    .WithMany(p => p.TeacherPerCoursePerSessionTimes)
                    .HasForeignKey(d => d.SessionTimeId)
                    .OnDelete(DeleteBehavior.Restrict)
                    .HasConstraintName("classsessions_sessiontime_id_fk");

                entity.HasOne(d => d.TeacherPerCourse)
                    .WithMany(p => p.TeacherPerCoursePerSessionTimes)
